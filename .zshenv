...
export OPENAI_API_KEY=$(cat $HOME/.config/openai/OPENAI_API_KEY 2> /dev/null || echo "")
export OPENAI_API_BASE=$(cat $HOME/.config/openai/OPENAI_API_BASE 2> /dev/null || echo "")
export OPENAI_API_HOST=$(cat $HOME/.config/openai/OPENAI_API_HOST 2> /dev/null || echo "")
