...
keyset('n', 'sk', '<c-w>k')
-- resize terminals
keyset('t', '<up>', '<c-\\><c-N><Cmd>res +2|startinsert<CR>')
keyset('t', '<down>', '<c-\\><c-N><Cmd>res -2|startinsert<CR>')
keyset('t', '<left>', '<c-\\><c-N><Cmd>vertical resize-2|startinsert<CR>')
keyset('t', '<right>', '<c-\\><c-N><Cmd>vertical resize+2|startinsert<CR>')
-- destroy terminals
