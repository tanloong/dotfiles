...
local custom_attach = function(client, bufnr)
  ...
  map("n", "[g", diagnostic.goto_prev, { desc = "previous diagnostic" })
  map("n", "]g", diagnostic.goto_next, { desc = "next diagnostic" })
  ...
  -- Below commands will highlight the current variable and its usages in the buffer.
