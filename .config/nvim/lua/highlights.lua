...
hl(0, 'SignColumn', { ctermbg = 'none', bg = 'none' })
hl(0, 'DiffAdd', { ctermfg = 'green', fg = 'green' })
hl(0, 'DiffChange', { ctermfg = 'yellow', fg = 'yellow' })
hl(0, 'DiffDelete', { ctermfg = 'red', fg = 'red' })
